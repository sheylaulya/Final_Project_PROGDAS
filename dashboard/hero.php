    ...
    <div class="main-wrapper">
        ...
        <div class="header">
            ...
            <div class="header-left">
                ...
                <a href="hero.php" class="logo logo-small">
                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul style="display: none;">
                                <li><a href="hero.php" class="active"
                                        style="color: #ffff; font-family: 'quicksand'; font-weight: 800; background-color: #680a83; border-radius: 0px 50px 50px 0px;">Hero</a>
                                </li>
                    ...
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Hero Landing Page</li>
                                <li><a href="tambah-data-hero.html" style="margin-left: 940px; color:#680a83">Tambah Data
                                        +</a></li>
                            </ul>
                        </div>
                    </div>
