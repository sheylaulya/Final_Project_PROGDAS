                    ...
                    <div class="col-md-12 d-flex">
                        <div class="content container-fluid">
                            ...
                            <div class="page-header">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <h3 class="page-title">Edit Data Best Seller</h3>
                                        <ul class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                            <li class="breadcrumb-item active">Edit Data Best Seller</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="card-body">
                                            <form action="#">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <input type="submit" style="width:200px; height: 40px; border: none; margin: auto; margin-top: 40px; color: white; background-color: #680a83; border-radius: 20px; font-family: 'quicksand'; font-weight: 800;" name="submit">
                                                </div>
                                            </form>
                                        </div>
                                        </td>
